...
│   ├── ...             # Implementation of the other passenger::* classes / definitions
...
├── pkg/                # Hold build packages to be published on the [Puppet forge](https://forge.puppetlabs.com/ULHPC/passenger)
