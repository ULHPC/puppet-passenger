...
By default, the [puppet-passenger](https://github.com/ULHPC/puppet-passenger) repository is bound to the [ulhpc-puppet-passenger](http://ulhpc-puppet-passenger.rtfd.org) project on Read the Docs (to avoid confusion with other passenger projects). 
